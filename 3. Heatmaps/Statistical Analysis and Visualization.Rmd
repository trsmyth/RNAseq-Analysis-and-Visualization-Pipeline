...
Data is tested for normality using the shapiro-wilk test. If all groups have p >= 0.05, a RM one-way ANOVA is conducted. If not, the Friedman test, an alternative for RM one-way ANOVA for non-parametric data, is conducted.
